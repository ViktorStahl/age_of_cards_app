...
enum Defence {
  ...
  shield(text: 'Shield', health: 1, trait: _raiseShield),
  towerShield(text: 'Tower Shield', health: 2, trait: _raiseShield);
...
''';
  ...
  const Defence(
      {required this.text, this.defence = 0, this.health = 0, this.trait});
