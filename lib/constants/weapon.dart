...
enum Weapon {
  ...
  bow(text: 'Bow', range: 24, power: 1, gold: 20),
  crossbow(text: 'Crossbow', range: 18, gold: 40),
  musket(text: 'Musket', range: 12, piercing: 1, gold: 40),
  longRifle(text: 'Long Rifle', range: 24, piercing: 1, gold: 60),
  pistol(text: 'Pistol', range: 8, pairing: true, piercing: 1, gold: 45),
  spinGun(text: 'Spin Gun', range: 12, attacks: 4, power: 1, gold: 80),
